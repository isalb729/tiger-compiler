...
class TyList; /*{int, string, rec}*/
class Field; /*{a: int, b: string}*/
class FieldList;

class Ty {
 public:
  enum Kind { RECORD, NIL, INT, STRING, ARRAY, NAME, VOID, XT};

  Kind kind;
  /*for nameType which actually refers to other types like int, string array ...*/
  Ty *ActualTy();
  bool IsSameType(Ty *);
