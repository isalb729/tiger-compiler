...
namespace T {
    ...
    void SeqStm::Print(FILE *out, int d) const {
        indent(out, d);
        fprintf(out, "SEQ(\n");
        this->left->Print(out, d + 4);
        fprintf(out, ",\n");
        this->right->Print(out, d + 4);
        fprintf(out, ")");
    }
    ...
    void MoveStm::Print(FILE *out, int d) const {
        indent(out, d);
        fprintf(out, "MOVE(\n");
        this->dst->Print(out, d + 4);
        fprintf(out, ",\n");
        this->src->Print(out, d + 4);
        fprintf(out, ")");
    }
    ...
    void CallExp::Print(FILE *out, int d) const {
        ...
        indent(out, d);
        fprintf(out, "CALL(\n");
        this->fun->Print(out, d + 4);
        for (; args; args = args->tail) {
            fprintf(out, ",\n");
            args->head->Print(out, d + 3);
        }
        fprintf(out, ")");
    }
